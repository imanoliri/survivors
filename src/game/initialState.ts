...
const tiles: Tile[] = [
  ...
  { id: '1-0', x: 1, y: 0, terrain: 'urban', buildings: [], specialLocation: { type: 'warehouse', loot: { materials: 4 }, scavenged: false } },
  ...
  { id: '1-1', x: 1, y: 1, terrain: 'urban', buildings: [], specialLocation: { type: 'supermarket', loot: { food: 4, water: 2 }, scavenged: false } },
  ...
  { id: '2-2', x: 2, y: 2, terrain: 'urban', buildings: [], specialLocation: { type: 'hospital', loot: { medicine: 3 }, scavenged: false } },
