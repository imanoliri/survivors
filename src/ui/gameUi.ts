...
export function canAdjustNumber(value:number,min:number,max:number,step:number,direction:1|-1):boolean{return adjustNumber(value,min,max,step,direction)!==value}
